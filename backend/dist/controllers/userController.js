...
exports.postUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, name_1, user, error_1;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                res.send(200).send(user === null || user === void 0 ? void 0 : user.toObject());
                return [2 /*return*/];
        }
    });
}); };
